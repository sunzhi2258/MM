...
//     if (appleNum === 1) {
//         $('.downLoad-apple').html("<img src='../image/index/二维码.png' style='height: 100px;margin:10px 50px '></img>").css({
//             'height': '120px'
//         });
//         appleNum = 2;
//     }
//     else if (appleNum === 2) {
//         $('.downLoad-apple').html(" <div>\n" +
...
//     if (androidNum === 1) {
//         $('.downLoad-android').html("<img src='../image/index/二维码.png' style='height: 100px;margin:10px 50px '></img>").css({
//             'height': '120px',
//             'transition': 'all 0.2s'
//         });
//         androidNum = 2;
//     }
//     else if (androidNum === 2) {
//         $('.downLoad-android').html(" <div>\n" +
